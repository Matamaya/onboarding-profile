...
<main id="paneles" class="container">
    ...
    <section id="panel-musica" class="tab-panel" role="tabpanel">
        <?php include __DIR__ . '/sections/part2-music.php'; ?>
    </section>
    <section id="panel-movies" class="tab-panel" role="tabpanel">
        <?php include __DIR__ . '/sections/part3-movies.php'; ?>
    </section>
    <section id="panel-menu" class="tab-panel" role="tabpanel">
        <?php include __DIR__ . '/sections/part4-menu.php'; ?>
    </section>
    <section id="panel-event" class="tab-panel" role="tabpanel">
        <?php include __DIR__ . '/sections/part5-event.php'; ?>
    </section>
    <section id="panel-travel" class="tab-panel" role="tabpanel">
